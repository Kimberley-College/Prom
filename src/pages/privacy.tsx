...
const Privacy: NextPage = () => (
  <BaseLayout>
    ...
    <Text>
      "Us", "We", and "Our Organisation" all refer to Kimberley College Prom 2022 - an Unincorporated Association.
      ...
      <Heading as="h3" size="lg">What data do we collect?</Heading>
      Kimberley College Prom 2022 collects the following data:

      Personal identification information (Name, email address)
      
      <Heading as="h3" size="lg">How do we collect your data?</Heading>
      ...
      <Heading as="h3" size="lg">How will we use your data?</Heading>
      ...
      Their privacy policy can be found <Link href="https://stripe.com/privacy">here</Link>

      <Heading as="h3" size="lg">How do we store your data?</Heading>
      ...
      <Heading as="h3" size="lg">What are your data protection rights?</Heading>
      ...
      If you make a request, we have one month to respond to you. If you would like to exercise any of these rights, please contact us at our email: <Link href="mailto:gdpr@prom.kim">gdpr@prom.kim</Link>

      <Heading as="h3" size="lg">Cookies</Heading>
      Cookies are text files placed on your computer to collect standard Internet log information and visitor behavior information. When you visit our websites, we may collect information from you automatically through cookies or similar technology.

      For further information, visit <Link href="https://allaboutcookies.org">allaboutcookies.org</Link>.
      ...
      Email us at: <Link href="mailto:gdpr@prom.kim">gdpr@prom.kim</Link>
